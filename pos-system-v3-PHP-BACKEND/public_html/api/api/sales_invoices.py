    ...
    def generate_invoice_pdf(self, invoice_id):
        ...
        try:
            ...
            title_style = ParagraphStyle(
                ...
                fontSize=6,  # Zmniejszone z 20 do 6
                spaceAfter=15,  # Zmniejszony odstęp
                alignment=TA_CENTER,
            ...
            section_style = ParagraphStyle(
                ...
                fontSize=6,  # Zmniejszone z 14 do 6
                spaceBefore=10,  # Zmniejszony odstęp
                spaceAfter=5,    # Zmniejszony odstęp
                textColor=colors.darkblue,
                fontName=font_name + '-Bold' if font_name == 'Helvetica' else font_name
            )
            ...
            header_table.setStyle(TableStyle([
                ...
                ('FONTSIZE', (0, 0), (0, 0), 6),  # Zmniejszone z 14 do 6
                ('FONTSIZE', (1, 0), (1, 0), 6),  # Zmniejszone z 9 do 6
            ...
            seller_buyer_table.setStyle(TableStyle([
                ...
                ('FONTSIZE', (0, 0), (-1, -1), 6),  # Zmniejszone z 10 do 6
            ...
            if positions:
                ...
                # Automatyczne dopasowanie szerokości - ReportLab automatycznie dopasuje do zawartości
                positions_table = Table(positions_data, colWidths=None, repeatRows=1)
                positions_table.setStyle(TableStyle([
                    ('ALIGN', (0, 0), (-1, -1), 'CENTER'),
                    ('ALIGN', (1, 1), (1, -1), 'LEFT'),  # Nazwy produktów do lewej
                    ('VALIGN', (0, 0), (-1, -1), 'TOP'),  # Wyrównanie do góry
                    ('FONTNAME', (0, 0), (-1, 0), font_name + '-Bold' if font_name == 'Helvetica' else font_name),
                    ('FONTNAME', (0, 1), (-1, -1), font_name),
                    ('FONTSIZE', (0, 0), (-1, 0), 6),  # Nagłówki - 6pt
                    ('FONTSIZE', (0, 1), (-1, -1), 6),  # Wszystkie dane - 6pt
                    ('FONTSIZE', (1, 1), (1, -1), 5),  # Nazwy produktów - 5pt (jeszcze mniejsze)
                    ('BOTTOMPADDING', (0, 0), (-1, -1), 2),  # Jeszcze mniejszy padding
            ...
            footer_table.setStyle(TableStyle([
                ...
                ('FONTNAME', (0, 0), (-1, -1), font_name),
                ('FONTSIZE', (0, 0), (-1, -1), 6),  # Zmniejszone z 9 do 6
