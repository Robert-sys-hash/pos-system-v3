...
@document_prefixes_bp.route('/api/document-prefixes', methods=['GET'])
def get_prefixes():
    """Pobierz wszystkie prefiksy dokumentów"""
    try:
...
@document_prefixes_bp.route('/api/document-prefixes/<int:prefix_id>', methods=['PUT'])
...
@document_prefixes_bp.route('/api/document-prefixes', methods=['POST'])
def create_prefix():
    """Utwórz nowy prefiks dokumentu"""
    try:
        data = request.get_json()
...
@document_prefixes_bp.route('/api/document-types', methods=['GET'])
...
@document_prefixes_bp.route('/api/generate-document-number', methods=['POST'])
...
@document_prefixes_bp.route('/api/create-default-prefixes/<int:location_id>', methods=['POST'])
...
@document_prefixes_bp.route('/api/locations-without-prefixes', methods=['GET'])
