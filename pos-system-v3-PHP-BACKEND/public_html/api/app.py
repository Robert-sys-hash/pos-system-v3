...
if __name__ == '__main__':
    ...
    # Zwróć aplikację dla CGI
    return app

# Główne uruchomienie
if __name__ == '__main__':
    # Development mode
    print("🚀 Uruchamianie POS System V3 API na porcie 5002...")
    print("📡 CORS skonfigurowany dla React frontend na localhost:3002")
    app = create_app()
    app.run(debug=False, host='0.0.0.0', port=5002)
else:
    # CGI Mode - tworzymy aplikację globalnie
    application = create_app()
    app = application  # Dla kompatybilności CGI
