...
const AdminPage = () => {
  ...
  const loadCategories = async () => {
    try {
      const response = await fetch('https://panelv3.pl/api/categories');
      if (response.ok) {
  ...
  const loadManufacturers = async () => {
    try {
      const response = await fetch('https://panelv3.pl/manufacturers');
      if (response.ok) {
        const data = await response.json();
  ...
  const updateManufacturer = async () => {
    ...
    try {
      const response = await fetch(`https://panelv3.pl/manufacturers/${editingManufacturer.id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
  ...
  const deleteManufacturer = async (id) => {
    ...
    try {
      const response = await fetch(`https://panelv3.pl/manufacturers/${id}`, {
        method: 'DELETE'
      });
  ...
  const loadUsers = async () => {
    try {
      const response = await fetch('https://panelv3.pl/users');
      if (response.ok) {
        const data = await response.json();
        setUsers(data.data || []);
      }
  ...
  const updateUser = async () => {
    ...
    try {
      const response = await fetch(`https://panelv3.pl/users/${editingUser.id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
  ...
  const deleteUser = async (id) => {
    ...
    try {
      const response = await fetch(`https://panelv3.pl/users/${id}`, {
        method: 'DELETE'
      });
  ...
  const loadDiscounts = async () => {
    try {
      const response = await fetch('https://panelv3.pl/discounts');
      if (response.ok) {
        const data = await response.json();
  ...
  const updateDiscount = async () => {
    ...
    try {
      const response = await fetch(`https://panelv3.pl/discounts/${editingDiscount.id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
  ...
  const deleteDiscount = async (id) => {
    ...
    try {
      const response = await fetch(`https://panelv3.pl/discounts/${id}`, {
        method: 'DELETE'
      });
  ...
  const loadDiscountStats = async () => {
    try {
      const response = await fetch('https://panelv3.pl/discount-reports/stats');
      if (response.ok) {
        const data = await response.json();
  ...
  const loadDiscountReports = async () => {
    try {
      const response = await fetch('https://panelv3.pl/discount-reports', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const loadDailyClosureReports = async () => {
    try {
      const response = await fetch('https://panelv3.pl/daily-closure/reports', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const loadDailyClosureSummary = async () => {
    try {
      const response = await fetch('https://panelv3.pl/daily-closure/summary', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(dailyClosureFilters)
      });
  ...
  const loadBackupSchedulerStatus = async () => {
    try {
      const response = await fetch('https://panelv3.pl/backup/scheduler/status');
      if (response.ok) {
        const data = await response.json();
  ...
  const loadBackupList = async () => {
    ...
    try {
      const response = await fetch('https://panelv3.pl/backup/list');
      if (response.ok) {
        const data = await response.json();
  ...
  const loadSettings = async () => {
    try {
      const response = await fetch('https://panelv3.pl/settings');
      if (response.ok) {
        const data = await response.json();
  ...
  const createBackup = async () => {
    try {
      const response = await fetch('https://panelv3.pl/backup/create', {
        method: 'POST'
      });
  ...
  const restoreBackup = async (filename) => {
    try {
      const response = await fetch('https://panelv3.pl/backup/restore', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const deleteBackup = async (filename) => {
    try {
      const response = await fetch('https://panelv3.pl/backup/delete', {
        method: 'DELETE',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ filename })
      });
  ...
  const toggleBackupScheduler = async () => {
    try {
      const response = await fetch('https://panelv3.pl/backup/scheduler/toggle', {
        method: 'POST'
      });
  ...
  const resetSettings = async () => {
    ...
    try {
      const response = await fetch('https://panelv3.pl/settings/reset', {
        method: 'POST'
      });
