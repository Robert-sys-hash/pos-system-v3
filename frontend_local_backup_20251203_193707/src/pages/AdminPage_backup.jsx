...
const AdminPage = () => {
  ...
  const handleBackupDatabase = async () => {
    try {
      setLoading(true);
      const response = await fetch('https://panelv3.pl/admin/backup', {
        method: 'POST',
        headers: {
  ...
  const loadBackupSchedulerStatus = async () => {
    try {
      const response = await fetch('https://panelv3.pl/admin/backup/scheduler/status');
      if (response.ok) {
        const data = await response.json();
        if (data.success) {
  ...
  const loadBackupList = async () => {
    try {
      const response = await fetch('https://panelv3.pl/admin/backup/list');
      if (response.ok) {
        const data = await response.json();
        if (data.success) {
  ...
  const handleStartScheduler = async () => {
    ...
    try {
      const response = await fetch('https://panelv3.pl/admin/backup/scheduler/start', {
        method: 'POST'
      });
      if (response.ok) {
        const data = await response.json();
  ...
  const handleStopScheduler = async () => {
    setBackupLoading(true);
    try {
      const response = await fetch('https://panelv3.pl/admin/backup/scheduler/stop', {
        method: 'POST'
      });
      if (response.ok) {
        const data = await response.json();
  ...
  const handleManualBackup = async () => {
    setBackupLoading(true);
    try {
      const response = await fetch('https://panelv3.pl/admin/backup/manual', {
        method: 'POST'
      });
      if (response.ok) {
        const data = await response.json();
  ...
  const deleteUser = async (userId) => {
    ...
    try {
      const response = await fetch(`https://panelv3.pl/admin/users/${userId}`, {
        method: 'DELETE',
      });
  ...
  const updateUser = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://panelv3.pl/admin/users/${editingUser.id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const deleteDiscount = async (discountId) => {
    ...
    try {
      console.log('🔄 Wysyłam zapytanie DELETE do:', `https://panelv3.pl/rabaty/${discountId}`);
  ...
  const updateDiscount = async () => {
    ...
    try {
      console.log('🔄 Wysyłam zapytanie PUT do:', `https://panelv3.pl/rabaty/${editingDiscount.id}`);
