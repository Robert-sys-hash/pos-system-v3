...
const DocumentPrefixesPage = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            const prefixesResponse = await fetch('https://panelv3.pl/api/document-prefixes');
            ...
            // Pobierz lokalizacje
            const locationsResponse = await fetch('https://panelv3.pl/api/locations');
            ...
            const typesResponse = await fetch('https://panelv3.pl/api/document-types');
            if (!typesResponse.ok) {
            ...
            const withoutPrefixesResponse = await fetch('https://panelv3.pl/api/locations-without-prefixes');
    ...
    const createDefaultPrefixesForLocation = async (locationId) => {
        try {
            const response = await fetch(`https://panelv3.pl/api/create-default-prefixes/${locationId}`, {
                method: 'POST',
                headers: {
    ...
    const saveEditedPrefix = async () => {
        try {
            const response = await fetch(`https://panelv3.pl/api/document-prefixes/${editingPrefix.id}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const saveNewPrefix = async () => {
        try {
            const response = await fetch('https://panelv3.pl/api/document-prefixes', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
