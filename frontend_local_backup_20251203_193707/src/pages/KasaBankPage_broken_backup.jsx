  ...
  return (
    <div style={{ 
      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
                    ...
                    <table style={{ 
                      ...
                      <tbody>
                        {filteredOperations.map((operacja, index) => {
                          const badge = getOperationTypeBadge(operacja.typ_operacji);
                          return (
                            <tr key={`${operacja.id}-${index}`} style={{ 
        ...
        {/* Stara sekcja - zostaje usunięta */}
        {false && (
        <div>
        {/* Ostatnie operacje - nowoczesny styl */}
        <div style={{ 
          padding: '1.5rem',
          backgroundColor: 'white',
          border: '1px solid #e9ecef',
          ...
          <div style={{ 
            ...
            <div style={{
              ...
              <i className="fas fa-list" style={{ color: '#6c757d', fontSize: '1rem' }}></i>
            </div>
            <h5 style={{ margin: 0, fontWeight: '600', color: '#212529' }}>
              Ostatnie Operacje
            </h5>
                  ...
                  <tr style={{ borderBottom: '2px solid #e9ecef' }}>
                    ...
                    <th style={{ 
                      ...
                      Forma płatności
                              ...
                              padding: '0.75rem 0.5rem', 
                              textAlign: 'right',
                              fontWeight: '600',acje.slice(0, 15).map((operacja, index) => (
                              color: '#dc3545'key={index} style={{ 
                            }}>orderBottom: '1px solid #e9ecef'
                              -{formatCurrency(doc.kwota)}
                            </td>0.75rem 0.5rem', verticalAlign: 'middle' }}>
                          </tr>m', color: '#6c757d' }}>
                        ))}   {operacja.data_operacji || 'Brak daty'}
                      </tbody>
                    </table>
                  </div>ticalAlign: 'middle' }}>
                ) : (tyle={{
                  <div style={{ adding: '0.25rem 0.5rem',
                    textAlign: 'center', 
                    padding: '2rem','500',
                    color: '#6c757d'
                  }}>racja.typ_operacji === 'KP' ? '#d1e7dd' : '#f8d7da',
                    <i className="fas fa-minus-circle fa-3x" style={{ marginBottom: '1rem', opacity: 0.3, color: '#dc3545' }}></i>p_operacji === 'KP' ? '#0f5132' : '#721c24'
                    <p style={{ margin: 0 }}>Brak dokumentów KW do wyświetlenia</p>
                  </div>
                )}
              </div>
            )}ddle' }}>
          </div>ja.opis || 'Brak opisu'}
        </div>
        ...
        <div>gn: 'middle',
        {/* Ostatnie operacje - nowoczesny styl */}
        <div style={{ operacji === 'KP' ? '#28a745' : '#dc3545'
          padding: '1.5rem',
          backgroundColor: 'white',acji === 'KP' ? '+' : '-'}{operacja.kwota?.toFixed(2) || '0.00'} zł
          border: '1px solid #e9ecef',
          borderRadius: '0.5rem', style={{ padding: '0.75rem 0.5rem', textAlign: 'center', verticalAlign: 'middle' }}>
          boxShadow: '0 0.125rem 0.25rem rgba(0, 0, 0, 0.075)'
        }}>adding: '0.25rem 0.5rem',
          <div style={{ 
            display: 'flex', '500',
            alignItems: 'center', 
            marginBottom: '1rem',c757d',
            paddingBottom: '0.75rem',
            borderBottom: '1px solid #e9ecef'
          }}>'gotówka'}
            <div style={{
              ...
              <i className="fas fa-list" style={{ color: '#6c757d', fontSize: '1rem' }}></i>olor: '#6c757d', 
            </div>rem 0',
            <h5 style={{ margin: 0, fontWeight: '600', color: '#212529' }}>
              Ostatnie Operacje
            </h5>wyświetlenia
          ...
          {operacje.length > 0 ? (
            <div style={{ overflowX: 'auto' }}>
              <table style={{ 
                ...
                <thead>
                  <tr style={{ borderBottom: '2px solid #e9ecef' }}>
                    <th style={{ rt default KasaBankPage;
                      padding: '0.75rem 0.5rem',                       textAlign: 'left',                       fontWeight: '600',                      color: '#495057',
                      borderBottom: '2px solid #e9ecef'
                    }}>
                      Data
                    </th>
