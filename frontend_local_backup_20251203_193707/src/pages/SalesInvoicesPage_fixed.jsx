...
const SalesInvoicesPage = () => {
  ...
  const fetchInvoices = async () => {
    try {
      ...
      const response = await fetch(`https://panelv3.pl/sales-invoices${params}`);
  ...
  const fetchReceipts = async () => {
    try {
      let url = `https://panelv3.pl/receipts-for-invoicing?limit=${receiptsLimit}&offset=${receiptsOffset}`;
  ...
  const fetchReceiptDetails = async (receiptId) => {
    try {
      const response = await fetch(`https://panelv3.pl/receipt-details/${receiptId}`);
      const data = await response.json();
  ...
  const checkReceiptEligibility = async (receiptId) => {
    try {
      const response = await fetch(`https://panelv3.pl/receipt-invoice-eligibility/${receiptId}`);
      const data = await response.json();
  ...
  const fetchCustomers = async () => {
    try {
      const response = await fetch('https://panelv3.pl/customers');
      const data = await response.json();
  ...
  const previewInvoice = async (invoiceId) => {
    try {
      const response = await fetch(`https://panelv3.pl/sales-invoices/${invoiceId}`);
      const data = await response.json();
  ...
  const downloadInvoicePDF = async (invoiceId, invoiceNumber) => {
    try {
      const response = await fetch(`https://panelv3.pl/sales-invoices/${invoiceId}/pdf`);
  ...
  const createInvoiceCorrection = async (invoiceId) => {
    ...
    try {
      const response = await fetch(`https://panelv3.pl/sales-invoices/${invoiceId}/correction`, {
        method: 'POST',
        headers: {
  ...
  const createInvoiceFromReceipt = async (receiptId, invoiceData) => {
    try {
      const response = await fetch(`https://panelv3.pl/sales-invoices/from-receipt/${receiptId}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
