...
const PurchaseInvoicesPage = () => {
  ...
  const loadMenuStats = async () => {
    try {
      setLoading(true);
      const response = await fetch('https://panelv3.pl/api/purchase-invoices/menu');
  ...
  const handleFileUpload = async (type, file) => {
    ...
    try {
      if (type === 'cennik') {
        ...
        const parseResponse = await fetch('https://panelv3.pl/api/purchase-invoices/import-cennik', {
          method: 'POST',
          body: formData
        });
        ...
        const saveResponse = await fetch('https://panelv3.pl/api/purchase-invoices/save-cennik', {
          method: 'POST',
          headers: {
        ...
        const endpoint = `https://panelv3.pl/api/purchase-invoices/import-${type}`;
