...
const CouponsPageSimple = () => {
  ...
  console.log('🎟️ CouponsPageSimple - kontekst lokalizacji:', {
    selectedLocation,
    locationId,
    selectedWarehouse,
    warehouseId,
  ...
  const handleAddCoupon = async (e) => {
    ...
    try {
      // Dodaj aktualną lokalizację do danych kuponu
      const couponWithLocation = {
        ...newCoupon,
        location_id: currentLocationId
      };
      
      console.log('🎟️ Dodaję kupon dla lokalizacji:', currentLocationId, couponWithLocation);
      await couponService.addCoupon(couponWithLocation);
      setNewCoupon({
        wartosc: '',
        data_waznosci: getDefaultExpiryDate(),
        numer_telefonu: '',
