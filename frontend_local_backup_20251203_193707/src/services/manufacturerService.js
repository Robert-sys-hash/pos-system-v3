...
class ManufacturerService {
  ...
  async getActiveManufacturers() {
    try {
      const response = await api.get('manufacturers/active');
      return response.data.data.manufacturers;
    } catch (error) {
  ...
  async bulkUpdateProductManufacturer(productIds, manufacturerId) {
    try {
      const response = await api.post('/products/bulk-update-manufacturer', {
  ...
  async updateProductManufacturer(productId, manufacturerId) {
    try {
      const response = await api.put(`/products/${productId}/manufacturer`, {
        manufacturer_id: manufacturerId
      });
      return response.data.data;
    } catch (error) {
  ...
  async updateProductSimplifiedName(productId, simplifiedName) {
    try {
      const response = await api.put(`/products/${productId}/simplified-name`, {
