...
export const locationPricingService = {
  ...
  getLocationPrices: async (locationId) => {
    try {
      const response = await api.get(`locations/${locationId}/prices`);
  ...
  setLocationPrice: async (locationId, productId, priceData) => {
    try {
      const response = await api.put(`locations/${locationId}/products/${productId}/price`, priceData);
      return response.data;
    } catch (error) {
  ...
  getCurrentPrice: async (locationId, productId) => {
    try {
      const response = await api.get(`locations/${locationId}/products/${productId}/price`);
      return response.data;
    } catch (error) {
  ...
  removeLocationPrice: async (locationId, productId) => {
    try {
      const response = await api.delete(`locations/${locationId}/products/${productId}/price`);
      return response.data;
    } catch (error) {
  ...
  copyPricesToLocation: async (sourceLocationId, targetLocationId, overwrite = false) => {
    try {
      const response = await api.post(`locations/${sourceLocationId}/copy-prices-to/${targetLocationId}`, {
        overwrite
      });
      return response.data;
    } catch (error) {
  ...
  getPriceHistory: async (locationId, productId) => {
    try {
      const response = await api.get(`locations/${locationId}/products/${productId}/price/history`);
      return response.data;
    } catch (error) {
