...
def create_app():
    ...
    # 2. Podstawowe blueprinty - ZAWSZE się rejestrują
    try:
    ...
    # 3. Locations blueprint z własnym prefix
    try:
    ...
    # 4. Dodatkowe blueprinty z obsługą błędów - ZAWSZE się próbują załadować
    try:
    ...
    # Blueprint autoryzacji - KRYTYCZNY!
    try:
