...
def create_app():
    ...
    # Rejestracja blueprintów API - WYŁĄCZONE NA RAILWAY PRZEZ BRAK SQLITE
    blueprint_errors = []
    print("⚠️  Blueprinty wyłączone na Railway przez brak SQLite")
    app.blueprint_errors = ["SQLite not available on Railway - blueprints disabled"]
    
    # TODO: Aktywować po naprawieniu SQLite na Railway
    # try:
    ...
    # ===== BLUEPRINTY WYŁĄCZONE NA RAILWAY - BRAK SQLITE =====
    print("⚠️  Wszystkie blueprinty wyłączone - brak SQLite na Railway")
    app.blueprint_errors = ["All blueprints disabled - SQLite not available on Railway"]
    
    """
    BLUEPRINTY WYŁĄCZONE - DO REAKTYWACJI PO NAPRAWIE SQLITE:
