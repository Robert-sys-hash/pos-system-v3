...
def create_app():
    ...
    # Konfiguracja CORS - dodajemy obsługę Heroku i localhost
    cors_origins = app_config.CORS_ORIGINS
    
    # Dodaj localhost do listy origins (dla development)
    localhost_origins = [
        'http://localhost:3002',
        'http://localhost:3000',
        'http://localhost:8000',
    ...
    try:
        ...
        app.register_blueprint(kasa_bank_bp, url_prefix='/api')
