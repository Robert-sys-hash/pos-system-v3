...
def create_app():
    ...
    try:
        ...
        # Dodaj blueprint cen lokalizacyjnych
        try:
            from api.location_pricing import location_pricing_bp
            app.register_blueprint(location_pricing_bp, url_prefix='/api')
            print("✅ Location Pricing blueprint OK")
        except Exception as e:
            print(f"❌ Błąd location_pricing blueprint: {e}")
        ...
        # Dodaj blueprint marż
        try:
            from api.marze import marze_bp
            app.register_blueprint(marze_bp, url_prefix='/api/marze')
            print("✅ Marze blueprint OK")
        except Exception as e:
            print(f"❌ Błąd marze blueprint: {e}")
        
        # Dodaj blueprint margin API
        try:
            from api.margin_api import margin_bp
            app.register_blueprint(margin_bp)
            print("✅ Margin API blueprint OK")
        except Exception as e:
            print(f"❌ Błąd margin_api blueprint: {e}")
