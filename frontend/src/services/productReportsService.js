...
export const productReportsService = {
  ...
  async getHighestRotationProducts(params = {}) {
    try {
      ...
      const response = await api.get(`/api/reports/products/rotation/highest?${queryParams}`);
  ...
  async getLowestRotationProducts(params = {}) {
    try {
      ...
      const response = await api.get(`/api/reports/products/rotation/lowest?${queryParams}`);
      return response.data;
    } catch (error) {
  ...
  async getBestsellingProducts(params = {}) {
    try {
      ...
      const response = await api.get(`/api/reports/products/bestsellers?${queryParams}`);
      return response.data;
    } catch (error) {
  ...
  async getSalesForecast(params = {}) {
    try {
      ...
      const response = await api.get(`/api/reports/products/forecast?${queryParams}`);
      return response.data;
    } catch (error) {
  ...
  async getProductsSummary(params = {}) {
    try {
      ...
      const response = await api.get(`/api/reports/products/summary?${queryParams}`);
      return response.data;
    } catch (error) {
